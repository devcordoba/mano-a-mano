...
| Perfiles | `/api/perfiles/` | CRUD completo |
| Organizaciones | `/api/organizaciones/` | CRUD + query opcional: **`propietario`** (id de usuario Django) |
| Oportunidades | `/api/oportunidades/` | CRUD + query: `ubicacion`, `causa`, `tipo_actividad`, `disponibilidad`, `activa`, **`organizacion`** (id de organización) |
| Postulaciones | `/api/postulaciones/` | CRUD + query: `oportunidad`, `voluntario` |
| Mensajes | `/api/mensajes/` | CRUD + query: `remitente`, `destinatario`, `oportunidad` |
